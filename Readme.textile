...
If you want to use auto-completion for Haskel, make sure you have ghc-mod install, if not do:
@stack install ghc-mod@

Also make sure, ghc-mod is on your path. On Ubuntu, for example, this means to add the following lines to your .bashrc if not already there:
